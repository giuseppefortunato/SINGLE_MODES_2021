...
struct prob_settings 
{
    ...
    int Np;
    std::string solver;
    std::vector<std::string> in_file;            //Input filename
    std::vector<std::string> test_file;          //test filename
    ...
    std::vector<int> Cols;                      //Fields columns to process
    std::vector<int> Cols_coords;               //Columns with coordinates
    std::vector<std::string> flag_method;        //Method to use
    std::string flag_wdb_be;        //flag write database basis extraction( modes and coefficients)
    ...
    std::vector<int> k_rec;                                 // number of neighbors for reconstruction
    std::vector<int> r_isomap;                              //number of eigenvectors to use in the manifold
    ...
    std::vector<int> r;                      //user defined rank (can be used for POD/SPOD/DMD)
    //------Parameters for DMD-----------
    ...
    double zmax;
    double zmin;
    std::vector<int> number_residuals;
